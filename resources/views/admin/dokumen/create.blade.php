...
@section('content')
    <div class="card">
        <form action="{{ route('admin.dokumen.store') }}" method="POST" enctype="multipart/form-data" class="dokumen-form">
            @csrf
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <select name="kategori" id="kategori" class="form-control">
                        ...
                        <option value="Perbup" {{ old('kategori') === 'Perbup' ? 'selected' : '' }}>Perbup</option>
