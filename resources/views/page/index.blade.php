        ...
        <div class="program-grid">
            @forelse (($programUnggulan ?? []) as $program)
                ...
                <a href="{{ ($programId && Route::has('program.show')) ? route('program.show', $programId) : '#' }}" class="program-card">
                    <div class="program-thumb-reveal" style="background-image:url('{{ $programGambar ? asset('storage/' . $programGambar) : asset('assets/images/program/default.jpg') }}')"></div>
                    <h3>{{ $programNama }}</h3>
            ...
            <div class="penghargaan-gallery">
                @forelse (($galleryPenghargaan ?? []) as $item)
                    ...
                    <div class="penghargaan-item">
                        <img
                            src="{{ $foto ? asset('storage/' . $foto) : asset('assets/images/penghargaan/default.jpg') }}"
                            alt="{{ $judul }}"
                            loading="lazy"
